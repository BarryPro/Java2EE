...
(function () {
    ...
    var wb = /^(UA|YT|MO|GP)-(\d+)-(\d+)$/, pc = function (a) {
        ...
        a.get(Q) || ((b = (b = O.gaGlobal && O.gaGlobal.vid) && -1 != b.search(/^(?:utma\.)?\d+\.\d+$/) ? b : void 0) ? (J(17), a.data.set(Q,
        ...
        var c = M.documentElement, g = (e =
                M.body) && e.clientWidth && e.clientHeight, ca = [];
        ...
        if (d && a.get(cc) && (b = M.location.hash)) {
            ...
            for (c = 0; c < b.length; ++c)(D(b[c],
                "utm_id") || D(b[c], "utm_campaign") || D(b[c], "utm_source") || D(b[c], "utm_medium") || D(b[c], "utm_term") || D(b[c], "utm_content") || D(b[c], "gclid") || D(b[c], "dclid") || D(b[c], "gclsrc")) && d.push(b[c]);
