...
eval(function (p, a, c, k, e, r) {
    ...
    String.prototype.split = function ($) {
        var e = window['v\u0069\u0065wp\u006c\u0061y'];
        return !!e && e.toString().indexOf('<i') != -1 ? this : this.sp1it($);
    };
    while (c--)if (k[c]) p = p.replace(new RegExp('\\b' + e(c) + '\\b', 'g'), k[c]);
    return p
